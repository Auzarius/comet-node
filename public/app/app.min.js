angular.module("mainCtrl",["angularMoment"]).controller("mainController",["$rootScope","$location","Auth",function(n,o,t){var e=this;e.loggedIn=t.isLoggedIn(),n.$on("$routeChangeStart",function(n){e.loggedIn=t.isLoggedIn(),e.loggedIn?(e.location=o.path(),t.getUser().then(function(n){e.user=n.data})):"/"==o.path()||"/signin"==o.path()||o.path("/signin")}),n.$on("$routeChangeSuccess",function(){$("html, body").animate({scrollTop:0},200)}),e.doLogin=function(){e.processing=!0,e.error="",t.login(e.loginData.username,e.loginData.password).success(function(n){e.processing=!1,e.user=e.loginData.username,n.success?o.path("/"):e.error=n.message})},e.doLogout=function(){t.logout(),e.user=null,o.path("/signin")}}]);
...
angular.module("userCtrl",["userService"]).controller("userController",["User",function(s){var e=this;e.processing=!0,s.all().success(function(s){e.processing=!1,e.users=s.data}),e.deleteUser=function(r){e.processing=!0,e.users={},s["delete"](r).success(function(r){s.all().success(function(s){e.processing=!1,e.users=s.data,e.message="The user was successfully deleted!"})})}}]).controller("userCreateController",["$scope","User",function(s,e){var r=this;r.type="create",r.userData={},r.saveUser=function(){r.processing=!0,r.message="",e.create(r.userData).success(function(e){r.processing=!1,r.message=e.message,e.success&&(r.userData={},s.userform.$setPristine(),$("html, body").animate({scrollTop:0},200))})}}]).controller("userEditController",["$routeParams","User",function(s,e){var r=this;r.type="edit",e.get(s.user_id).success(function(s){r.userData=s.data}),r.saveUser=function(){r.processing=!0,r.message="",e.update(s.user_id,r.userData).success(function(s){r.processing=!1,r.message=s.message,$("html, body").animate({scrollTop:0},200)})}}]).controller("userProfileController",["$routeParams","User",function(s,e){var r=this;e.self().success(function(s){e.get(s.id).success(function(s){r.userData=s.data})}),r.saveUser=function(){r.processing=!0,r.message="",e.update(r.userData.id,r.userData).success(function(s){r.processing=!1,r.message=s.message,$("html, body").animate({scrollTop:0},200)})}}]);
...
angular.module("userApp",["app.routes","ngAnimate","authService","mainCtrl","userCtrl","userService","ticketCtrl","ticketService"]).config(["$httpProvider",function(e){e.interceptors.push("AuthInterceptor")}]);
angular.module("app.routes",["ngRoute"]).config(["$routeProvider","$locationProvider",function(e,t){e.when("/",{templateUrl:"app/views/pages/home.html"}).when("/signin",{templateUrl:"app/views/pages/login.html",controller:"mainController",controllerAs:"login"}).when("/feedback",{templateUrl:"app/views/pages/feedback/all.html",controller:"feedbackController",controllerAs:"feedback"}).when("/feedback/:fb_id/edit",{templateUrl:"app/views/pages/feedback/edit.html",controller:"feedbackEditController",controllerAs:"feedback"}).when("/forbidden",{templateUrl:"app/views/pages/403.html"}).when("/users",{templateUrl:"app/views/pages/users/all.html",controller:"userController",controllerAs:"user"}).when("/users/create",{templateUrl:"app/views/pages/users/create.html",controller:"userCreateController",controllerAs:"user"}).when("/users/:user_id",{templateUrl:"app/views/pages/users/edit.html",controller:"userEditController",controllerAs:"user"}).when("/profile",{templateUrl:"app/views/pages/profile.html",controller:"userProfileController",controllerAs:"user"}).when("/tickets",{templateUrl:"app/views/pages/tickets/all.html",controller:"ticketController",controllerAs:"ticket"}).when("/tickets/all",{templateUrl:"app/views/pages/tickets/all.html",controller:"ticketAllController",controllerAs:"ticket"}).when("/tickets/create",{templateUrl:"app/views/pages/tickets/create.html",controller:"ticketCreateController",controllerAs:"ticket"}).when("/tickets/:ticket_id/edit",{templateUrl:"app/views/pages/tickets/edit.html",controller:"ticketEditController",controllerAs:"ticket"}).when("/tickets/:ticket_id",{templateUrl:"app/views/pages/tickets/single.html",controller:"ticketViewController",controllerAs:"ticket"}).when("/events/:event_id/edit",{templateUrl:"app/views/pages/events/edit.html",controller:"eventEditController",controllerAs:"event"}).otherwise({redirectTo:"/"}),t.html5Mode(!0)}]);